...
- [ ] **live-ops-manager:** propose the real Week 5 code list (free-tier rewards only — Dew, common/rare seeds, a short Luck Boost) to replace the `SPROUT1K` placeholder in `Codes.luau` before 7 Nov.
