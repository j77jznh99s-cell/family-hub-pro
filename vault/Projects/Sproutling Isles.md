...
| Frostbloom Festival (winter event) | Full spec written 2026-09-26 (not code yet) — see [[Sproutling Isles - Launch & Live Ops]]. Species payback numbers computed and checked, pending game-designer confirmation. Build due before 12 Dec |
...
- [ ] **game-designer:** confirm the Frostbloom Festival numbers against the payback rules (same process as the Halloween confirmation) — see the note above the winter species table in [[Sproutling Isles - Launch & Live Ops]].
